    ...
    return (
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-4 text-center text-gray-500">Loading organizations...</div>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Configure multi-tenant settings, integrations, and data sources</p>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
            <div className="text-6xl mb-4">🏢</div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">No Organizations Found</h2>
            <p className="text-gray-600 mb-6">
              No organizations are currently configured in the system.
            </p>
            <p className="text-sm text-gray-500">
              Check the browser console for any errors, or verify that the database migrations were applied correctly.
            </p>
          </div>
        </div>
      </div>
